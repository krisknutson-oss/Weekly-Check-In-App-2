...
export const COLOR_SCHEMES: ColorSchemeConfig[] = [
  ...
  // ================= DAY / WHITE / LIGHT THEMES =================
  {
    id: 'pure-white',
    name: 'Pure White (Day)',
    subtitle: 'Crisp snow white background with high-contrast deep text and light blue panels',
    isLight: true,
    preview: {
      bg: '#FFFFFF',
      card: '#EFF6FF',
  ...
  },
  {
    ...
    subtitle: 'Classic warm ivory archival ledger with soft light-blue boxes & antique bronze text',
    isLight: true,
    preview: {
      bg: '#FAF7F0',
      card: '#EFF6FF',
  ...
  },
  {
    ...
    subtitle: 'Contemporary light mist background with light blue boxes and cobalt accents',
    isLight: true,
    preview: {
      bg: '#F8FAFC',
      card: '#EFF6FF',
  ...
  },
  {
    ...
    subtitle: 'Warm cozy linen background with light sky-blue card containers',
    isLight: true,
    preview: {
      bg: '#FFFBEB',
      card: '#EFF6FF',
  ...
  },
  {
    ...
    subtitle: 'Ultra clean white stone background with light blue boxes and emerald accents',
    isLight: true,
    preview: {
      bg: '#F8FAFC',
      card: '#EFF6FF',
...
export function createCustomColorScheme(bgHex: string): ColorSchemeConfig {
  ...
  if (isLight) {
    return {
      ...
      subtitle: `Custom background (${bgHex}) with light blue boxes and high-contrast text`,
      isLight: true,
      preview: {
        bg: bgHex,
        card: '#EFF6FF',
